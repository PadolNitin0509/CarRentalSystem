package com.Project.models.booking;
...
private double taxAmount;
	...
	public ConfirmBookingDTO(int bookingid, double taxAmount, String driverName ,String photo, int categoryId, int totalDays, Date bookingDate, String carCatImg, String location,
